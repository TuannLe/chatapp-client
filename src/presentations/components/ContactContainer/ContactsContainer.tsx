...
import { useFriendStore, useRouterStore, useAuthStore } from "../../../core/store";
...
function SearchArea() {
  ...
  const listUser = useFriendStore((state) => state.listUserResult)
...
function ContactItems({
  ...
  return (
    <div
      className={`${messageStore.currentChatPerson?.id == contact.info.id
