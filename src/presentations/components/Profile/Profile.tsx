      ...
      <div className="w-[450px] flex flex-col items-center space-y-[3px]">
        <div className="w-full p-[5px] flex flex-row items-center justify-between">
          <div className="flex flex-row items-center space-x-[4px] ">
            <p className="text-[13px] w-[120px] text-[#65676b] dark:text-[#e4e6eb]">Username :</p>
            <p className="text-[15px] dark:text-[#65676b]">{authStore.username}</p>
          </div>
          <div>
        ...
        <div className="w-full p-[5px] flex flex-row items-center justify-between">
          <div className="flex flex-row items-center space-x-[4px] ">
            <p className="text-[13px] w-[120px] text-[#65676b] dark:text-[#e4e6eb]">Email :</p>
            <p className="text-[15px] dark:text-[#65676b]">{authStore.email}</p>
          </div>
          {/* <div>
            <button className=" font-medium text-blue-500">Edit</button>
          </div> */}
        ...
        <div className="w-full p-[5px] flex flex-row items-center justify-between">
          <div className="flex flex-row items-center space-x-[4px] ">
            <p className="text-[13px] w-[120px] text-[#65676b] dark:text-[#e4e6eb]">Contact number :</p>
            <p className="text-[15px] dark:text-[#65676b]">0984848484</p>
          </div>
          <div>
            <button className=" font-medium text-blue-500">Edit</button>
          </div>
